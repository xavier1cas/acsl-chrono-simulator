...
body_1->AddVisualShape(trimesh_shape_1, chrono::ChFramed(chrono::ChVector3d(0,0,0), chrono::ChQuaternion<>(1,0,0,0)));
...
body_2->AddVisualShape(trimesh_shape_2, chrono::ChFramed(chrono::ChVector3d(0,0,0), chrono::ChQuaternion<>(1,0,0,0)));
...
body_3->SetName("sqrbp-2");
body_3->SetPos(chrono::ChVector3d(0.0984471609373536,0.187071795527612,0.17256855449029));
body_3->SetRot(chrono::ChQuaternion<>(1,0,0,0));
body_3->SetMass(1.67236138725861);
body_3->SetInertiaXX(chrono::ChVector3d(0.0233070324786724,0.0160580843956144,0.0271717864469372));
body_3->SetInertiaXY(chrono::ChVector3d(1.10006555036583e-07,-0.000482088295393743,1.23260346821255e-06));
body_3->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(-0.0163151142227842,0.0102080920244478,0.017016814810521),chrono::ChQuaternion<>(1,0,0,0)));
...
body_3->AddVisualShape(trimesh_shape_3, chrono::ChFramed(chrono::ChVector3d(0,0,0), chrono::ChQuaternion<>(1,0,0,0)));
...
body_3->GetCollisionModel()->AddShape(collshape_3,chrono::ChFramed(chrono::ChVector3d(-0.107892648208808,0.0102797625509045,0.0890880486150274), mr));
...
body_3->GetCollisionModel()->AddShape(collshape_3,chrono::ChFramed(chrono::ChVector3d(-0.0109730630310874,0.0102812455678535,-0.0391445906934458), mr));
mr(0,0)=-1; mr(1,0)=-3.38384126574542E-15; mr(2,0)=0;
...
collshape_3 = chrono_types::make_shared<chrono::ChCollisionShapeBox>(mat_3,0.0164047740043827,0.122065278616947,0.5);
body_3->GetCollisionModel()->AddShape(collshape_3,chrono::ChFramed(chrono::ChVector3d(0.0859073517911931,0.0102797625509052,0.0890880486150245), mr));
...
body_5->SetName("prop_3-1");
body_5->SetPos(chrono::ChVector3d(0.184376362665988,0.0866378447874975,0.154498963796845));
body_5->SetRot(chrono::ChQuaternion<>(0.642220241731439,-3.53271206234227e-15,1.51678818982111e-15,0.766520163538058));
...
body_5->AddVisualShape(trimesh_shape_5, chrono::ChFramed(chrono::ChVector3d(0,0,0), chrono::ChQuaternion<>(1,0,0,0)));
...
//   Entity 0: C::E name: body_3 , SW name: sqrbp-2 ,  SW ref.type:1 (1)
...
//   Entity 0: C::E name: body_3 , SW name: sqrbp-2 ,  SW ref.type:2 (2)
...
dB = chrono::ChVector3d(0,0,1);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_3,body_4,false,cA,cB,dB);
...
dA = chrono::ChVector3d(-3.49148133884316e-15,6.98296267768625e-15,1);
dB = chrono::ChVector3d(0,0,-1);
std::dynamic_pointer_cast<chrono::ChLinkMateGeneric>(link)->Initialize(body_3,body_2,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_3 , SW name: sqrbp-2 ,  SW ref.type:1 (1)
//   Entity 1: C::E name: body_5 , SW name: prop_3-1 ,  SW ref.type:1 (1)
link = chrono_types::make_shared<chrono::ChLinkMateParallel>();
...
//   Entity 0: C::E name: body_3 , SW name: sqrbp-2 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_5 , SW name: prop_3-1 ,  SW ref.type:2 (2)
link = chrono_types::make_shared<chrono::ChLinkMateDistanceZ>();
...
dB = chrono::ChVector3d(0,0,-1);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->SetFlipped(true);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->Initialize(body_3,body_1,false,cA,cB,dA,dB);
...
dA = chrono::ChVector3d(-3.49148133884316e-15,6.98296267768625e-15,1);
dB = chrono::ChVector3d(0,0,-1);
std::dynamic_pointer_cast<chrono::ChLinkMateGeneric>(link)->Initialize(body_3,body_1,false,cA,cB,dA,dB);
...
dB = chrono::ChVector3d(0,0,1);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_3,body_1,false,cA,cB,dB);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->SetDistance(0);
